...
const WEIGHT_CLUSTER = 3
const WEIGHT_NODE = 4
const WEIGHT_POD = 5
const WEIGHT_NAMESPACE = 6
...
var DefaultConfig = {
    ...
    _nodeAttrsInfra: function (node: Node): NodeAttrs {
        ...
        switch (node.data.Type) {
            ...
            case "Node":
                attrs.icon = "\uf109"
                attrs.weight = WEIGHT_NODE
                break
            case "Pod":
                attrs.icon = "\uf24d"
                attrs.weight = WEIGHT_POD
